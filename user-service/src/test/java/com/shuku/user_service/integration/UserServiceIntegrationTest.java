package com.shuku.user_service.integration;
...
import com.shuku.user_service.testsupport.MySqlTestcontainersBase;
...
public class UserServiceIntegrationTest extends MySqlTestcontainersBase {
    ...
    void createUser_viaRestApi_persistsAndReturnsUser(){
        ...
        assertThat(response.getBody().getName()).isEqualTo("Chintu");
        assertThat(response.getBody().getSurname()).isEqualTo("Pintu");
        assertThat(response.getBody().getEmail()).isEqualTo("wow@gmail.com");
        assertThat(response.getBody().getAddress()).isEqualTo("123ChintuStreet");
        ...
        assertThat(loaded.getBody().getEmail()).isEqualTo("wow@gmail.com");
    ...
    void updateUser_viaRestApi_persistsChanges() {
        ...
        assertThat(updateResponse.getBody()).isEqualTo("User Created Successfully");
    ...
    void deleteUser_viaRestApi_removesUser() {
        ...
        ResponseEntity<String> afterDelete =
                restTemplate.getForEntity("/api/v1/user/" + id, String.class);
